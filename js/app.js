...
const App = {
  ...
  vaiAVista(nome) {
    ...
    // Riporta la vista in cima: senza questo, cambiando scheda si ritrova la posizione di
    // scroll lasciata l'ultima volta, nascondendo ad esempio la barra di ricerca in alto.
    // L'Agenda è esclusa apposta: lì lo scroll è già gestito da js/agenda.js, che centra
    // sull'orario attuale quando si guarda il giorno di oggi — un reset qui glielo romperebbe.
    const contenuto = document.getElementById('contenuto-principale');
    if (contenuto && nome !== 'agenda') contenuto.scrollTop = 0;
  },
